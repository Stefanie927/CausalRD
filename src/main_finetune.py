...
from util.datasets import build_dataset, ODIRDatasetSingle_diffusion
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_dir/ourmethod_6/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir/ourmethod_6/',
...
def main(args):
    ...
    train_img_dir = "./data/OIA_ODIR/cropped_ODIR-5K_Training_Images"
    train_encoder_feature_pkl = r"./data/OIA_ODIR/ViT_features/train_features.pkl"

    dataset_train = ODIRDatasetSingle_diffusion(train_df, train_encoder_feature_pkl, train_img_dir, is_train=True, args=args)
    ...
    # # load diffusion
    # ckpt_path = r"E:\code\fundus\Causal_RETFound\output_dir\ODIR\ourmethod_6\opt620000.pth"
    ...
    # state_dict = checkpoint['model_state_dict']
    # model_sd_keys = set(model.causal_model.state_dict().keys())
    # ckpt_sd_keys = set(state_dict.keys())
    # missing_keys = model_sd_keys - ckpt_sd_keys
    # unexpected_keys = ckpt_sd_keys - model_sd_keys
    # print(f"Missing keys: {missing_keys}")
    # print(f"Unexpected keys: {unexpected_keys}")
    # model.causal_model.load_state_dict(state_dict, strict=False)
    # model = model.to(device)
    ...
    #### diffusion optimier 
    optimizer = torch.optim.Adam(model.parameters(), lr=args.diffusion_lr, weight_decay=0)    
