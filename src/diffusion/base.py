...
from diffusion_utils.config_base import BaseConfig
import enum
import math
...
class GaussianDiffusionBeatGans:
    ...
    def training_losses(self,
        ...
        if self.loss_type in [    # loss_type=mse
                LossType.mse,
                LossType.l1,
        ]:
            ...
            terms['causal_loss'] = model_forward.causal_loss
            ...
            if self.loss_type == LossType.mse:   # loss_type=mse
